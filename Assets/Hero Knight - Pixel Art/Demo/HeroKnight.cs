...
public class HeroKnight : MonoBehaviour
{
    ...
    private float interactionDistance = 2.25f;
    ...
    void Update()
    {
        ...
        //Attack
        else if (Input.GetKeyDown("space") && m_timeSinceAttack > 0.25f && !m_rolling)
        {
            m_currentAttack++;
        ...
        if (Input.GetKeyDown("w") && m_canWallJump)
        {
            try
            {
                m_animator.SetTrigger("Jump");
                ...
                float wallJumpForce = m_jumpForce;
                if (m_wallSensorR1.State() || m_wallSensorR2.State())
                    m_body2d.velocity = new Vector2(-wallJumpForce, m_jumpForce);
            ...
            {
                Debug.LogError("Error during Wall Jump: " + e.Message);
            }
        }
        //Interact Action
    ...
    void Interact()
    {
        ...
        foreach (Collider2D hitCollider in hitColliders)
        {
            if (hitCollider.CompareTag("Objects"))
            {
                ...
                Debug.Log("Interacting with object: " + hitCollider.gameObject.name);
            }
        }
    }
